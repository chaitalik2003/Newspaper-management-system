...
// Write the SQL query to fetch the name from the `customers` table
$sql = "SELECT name FROM customers WHERE id = '$uid'";
$result = mysql_query($sql, $connects);

// Check if the query was successful
if (!$result) {
    die("Query failed: " . mysql_error()); // Output the error message
}
...
if ($row = mysql_fetch_assoc($result)) {
    $username = $row['name'];  // Using associative array for readability
}
  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    <script>
        function updateCustomer() {
            document.forms["update_Profile_Cust"].action = "update_Profile_Cust.php?operation=update";
            document.forms["update_Profile_Cust"].submit();
        }

        function deleteCustomer() {
            document.forms["update_Profile_Cust"].action = "update_Profile_Cust.php?operation=delete";
            document.forms["update_Profile_Cust"].submit();
        }
    </script>
</head>
...
<header class="hero">
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-md-offset-6 col-xs-12">
              ...
              <div class="hero-text">
                <h1><span>Hi <i><?php echo htmlspecialchars($username); ?> </span>
          ...
          <div class="container">
              <div class="row">
                  <div class="col-md-12">
                      ...
                      <h1 class="heading purple" id="1st_head"><span class="purple">Update</span> Profile <br></h1>
                      <p>TO UPDATE THE PROFILE YOU NEED TO FILL ALL THE FIELDS AND TO DELETE ACCOUNT ENTER YOUR USER-ID</p>
                      <!-- Register form -->
                      <div class="container">
                        <center>
                          <form name="update_Profile_Cust" action="update_Profile_Cust.php" method="post">
                            <table class="form-table">
                                <tr>
                                    <td><label for="id">Customer ID:</label></td>
                                    <td><input type="text" id="id" name="id" value="<?php echo $uid;?>" required></td>
                                </tr>
                                <tr>
    ...
    if (isset($_GET['operation']) && $_GET['operation'] == 'update') {
        ...
        $sql = "UPDATE customers SET name='$_POST[name]', email='$_POST[email]', password='$_POST[password]', contact='$_POST[contact]', address='$_POST[address]', locationArea='$_POST[locationArea]', subscription_start='$_POST[subscription_start]', subscription_end='$_POST[subscription_end]', newspaper='$_POST[newspaper]' WHERE id='$_POST[id]'";
