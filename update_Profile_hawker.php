...
$sql = "SELECT name FROM paperhawkers WHERE id = '$uid'";
...
<head>
    ...
    <title>Update Hawker's Profile</title>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-md-offset-6 col-xs-12">
              ...
              <div class="hero-text">
                <h1><span>Hi <i><?php echo htmlspecialchars($username); ?>
            </div>
          </div>
        </div>
      </header>
          ...
          <div class="container">
              <div class="row">
                  ...
                  <h4 class="sub-heading">Hawker's</h4>
                      ...
                      <div class="container">
                        <center>
            <form name="newspaperhawker_reg" action="update_Profile_hawker.php" method="post">
